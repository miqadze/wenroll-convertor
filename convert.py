...
try:
    ...
    s3.upload_file(folder_name + "_480p.ts", "test-wenroll", folder_name + "/" + folder_name + "_480p0.ts")
    s3.upload_file(folder_name + "_720p.ts", "test-wenroll", folder_name + "/" + folder_name + "_720p0.ts")
    s3.upload_file(folder_name + "_1080p.ts", "test-wenroll", folder_name + "/" + folder_name + "_1080p0.ts")
